...
set RUN_NAME=MIRMU_CMath-coord
set QUERY_URL=http://mir2.fi.muni.cz:8085/webmias-ntcir-12
rem set QUERY_URL=https://mir.fi.muni.cz/webmias-ntcir-or
...
rem set CMD_LINE_ARGS=cz.muni.fi.mireval.query.QueryApp -queryurl %QUERY_URL% -runname %1 -topics %TOPICS% -outputdir %OUTPUT_DIR%

rem Next command gets results of MIaS for the specified topics and evaluates them
set CMD_LINE_ARGS=cz.muni.fi.mireval.query.QueryApp -queryurl %QUERY_URL% -runname %1 -topics %TOPICS% -outputdir %OUTPUT_DIR% -qrels d:\skola\mir\SIGIR-2015\NTCIR11_Math-qrels.dat
